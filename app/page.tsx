  ...
  return (
    <div className="min-h-screen px-6 py-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        ...
        <section className="relative overflow-hidden rounded-[36px] border border-white/70 bg-white/80 p-6 shadow-[0_24px_50px_-30px_var(--shadow)] backdrop-blur">
          ...
          <div className="relative z-10 flex min-h-[70vh] flex-col">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.3em] text-[color:var(--ink-muted)]">
              ...
              {hasOutfit ? (
                ...
                <div className="flex h-full flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-2 max-w-sm text-sm text-[color:var(--ink-muted)]">
                    Upload items, then tap generate to see a combined preview of
